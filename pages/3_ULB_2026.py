...
from Security.auth import check_login
...
with tab2:
    ...
    discharge = (
        df.groupby("(A) Name of ULB")["Drain_Discharge_Clean"]
        .first()
        .fillna("Not Reported")
        .value_counts()
        .reset_index()
    ...
    effluent = (
        df.groupby("(A) Name of ULB")["Industrial_Effluent_Clean"]
        .first()
        .fillna("Not Reported")
        .value_counts()
        .reset_index()
    ...
    sludge = (
        df.groupby("(A) Name of ULB")["Management_of_Sludge_Clean"]
        .first()
        .fillna("Not Reported")
        .value_counts()
        .reset_index()
